...
static int __maybe_unused dwc3_runtime_suspend(struct device *dev)
{
...
static int __maybe_unused dwc3_runtime_resume(struct device *dev)
{
	struct dwc3     *dwc = dev_get_drvdata(dev);
	int		ret;
...
static int __maybe_unused dwc3_runtime_idle(struct device *dev)
{
	struct dwc3     *dwc = dev_get_drvdata(dev);
